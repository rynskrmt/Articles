...
Wiki-Goは、単一バイナリで動作するシンプルなFlat-File Wikiです。
...
ナレッジ共有ツールの導入を検討している方は、まずWiki-Goを試してみてはいかがでしょうか。 　　
...
ソフトウェアエンジニアとして、**現実の組織・制約・意思決定の中で、ソフトウェアを“成立させる”とは何か**、再考する、良いきっかけになりました。この話題もまたどこかのタイミングで記事にしたいと思います。  
